...
Seedgraph v2 is an **implemented, test-green system**, not just a design repository: all build
phases are built and adversarially verified, with real corpora in use (a 489-paper DiD corpus
drives current dogfooding of the ambient trigger). The grounded-reasoning-colleague frame
described above is the current shared understanding of what the system is and is for.
